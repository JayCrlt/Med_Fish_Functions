...
meow               <- st_read("/Users/jeremycarlot/Desktop/Datos Atlántico/MEOW-TNC/meow_ecos.shp")
load("/Users/jeremycarlot/Desktop/Datos Atlántico/community_and_traits.RData")
load("/Users/jeremycarlot/Desktop/Datos Atlántico/survey_all_combined.RData")
load("/Users/jeremycarlot/Desktop/Datos Atlántico/FishGlob_public_clean.RData")
...
##### Export Figure
ggsave(Figure_1a, filename = "Figure_1a_Eli.png", path = "Outputs/", device = "png", width = 16, height = 4, dpi = 300)  
ggsave(Figure_1b, filename = "Figure_1b_Eli.png", path = "Outputs/", device = "png", width = 7, height = 7, dpi = 300)  
ggsave(Figure_1c, filename = "Figure_1c_Eli.png", path = "Outputs/", device = "png", width = 2, height = 2, dpi = 300)  
ggsave(Figure_1d, filename = "Figure_1d_Eli.png", path = "Outputs/", device = "png", width = 2, height = 2, dpi = 300)  
ggsave(Figure_1e, filename = "Figure_1e_Eli.png", path = "Outputs/", device = "png", width = 2, height = 2, dpi = 300)  
ggsave(Figure_1f, filename = "Figure_1f_Eli.png", path = "Outputs/", device = "png", width = 2, height = 2, dpi = 300)  
ggsave(Figure_1g, filename = "Figure_1g_Eli.png", path = "Outputs/", device = "png", width = 2, height = 2, dpi = 300)  
ggsave(Figure_1h, filename = "Figure_1h_Eli.png", path = "Outputs/", device = "png", width = 2, height = 2, dpi = 300)  
ggsave(Figure_1i, filename = "Figure_1i_Eli.png", path = "Outputs/", device = "png", width = 10, height = 0.2, dpi = 300)  